...
def ticket_class_view_3(request):  # 방법 3
    ...
    #    survived_percentage_series_data = list()
    ...
    # survived_percentage_series_data.append(entry['rate'])
    ...
    # survived_percentage_series = {
    #    'name': 'Survived_pecentage',
    #    'data': survived_percentage_series_data,
    #    'color': 'blue'
    # }
    chart = {
        'chart': {'type': 'column'},
...
def json_example(request):  # 방법4 # 접속 경로 'json-example/'에 대응하는 뷰
...
def covid19_jupyter(request):
    return render(request, 'covid19_jupyter.html')
